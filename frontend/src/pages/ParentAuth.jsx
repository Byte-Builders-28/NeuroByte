...
export default function ParentAuth() {
    ...
    return (
        <div className="auth-page auth-page-parent">
            ...
            <div className="auth-form-container animate-slide-up">
                ...
                <div className="auth-form-card">
                    <div className="auth-form-icon auth-form-icon-parent">
                    ...
                    <p className="auth-form-subtitle">
                        {isLogin
                            ? "Sign in to monitor and manage your child's learning."
                    ...
                    <form onSubmit={handleSubmit} className="auth-form">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="auth-submit-btn auth-submit-parent"
                        >
                            {loading ? (
